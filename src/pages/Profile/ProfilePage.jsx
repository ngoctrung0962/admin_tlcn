...
import TabTeacherProfile from "./Tab/TabTeacherProfile";
  ...
  return (
    <div>
      <div className="container-fluid">
        ...
        <div className="container__tablee pb-3">
          <Tabs defaultActiveKey="infomation">
            <Tab eventKey="infomation" title="Thông tin tài khoản">
              {loading ? (
            ...
            {user?.role === Enums.ROLE.TEACHER && (
              <Tab eventKey="content" title="Thông tin giảng viên">
                <TabTeacherProfile user={user} />
              </Tab>
            )}
          </Tabs>
        </div>
